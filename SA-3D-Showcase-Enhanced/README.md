...
- Open any camera and use **Choose MP4 / WebM → Deploy feed** to upload a real demo video and assign it to an online CCTV feed. Uploads are limited to 60 MB and are stored under `backend/media/` (on free Render instances this storage is temporary).
