...
The **AR View** control sits in the 3D Spatial View toolbar. It does not replace the regular desktop viewer. The main desktop scene uses animated offshore-water geometry, shadowed plant geometry, and operational lights; all normal personnel, camera, drone, and alert interactions remain in the standard viewer.
