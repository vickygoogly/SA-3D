...
## New: Signal Atlas UI and AR View

This revision adds a refined **Signal Atlas** command-centre UI, an immersive refinery-horizon treatment behind the existing interactive 3D EPS-1 model, contextual remote platforms, and a **View in AR** flow for compatible phones/tablets. See [AR View instructions](docs/AR-VIEW.md).
