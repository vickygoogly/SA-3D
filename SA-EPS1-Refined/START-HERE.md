...
Application branding updated in the header, browser title, report download name and package metadata. The existing project folder name is retained so your hosting Root Directory can stay the same.
