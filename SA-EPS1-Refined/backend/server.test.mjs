...
test('backend serves frontend/model, persists acknowledgment and resets demo',async()=>{
 ...
 try{
  ...
  for(const asset of ['/operations.css','/refinement.css','/operations.js','/vendor/lucide.min.js'])assert.equal((await fetch(base+asset)).status,200,asset+' must be served');
