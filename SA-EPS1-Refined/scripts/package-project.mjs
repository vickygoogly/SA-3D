...
const zip=path.join(destination,'Signal-Atlas-EPS1-Road-Clearance-Fix.zip');execFileSync('zip',['-q','-r',zip,'SA-EPS1-Refined'],{cwd:destination});console.log(JSON.stringify({zip,bytes:statSync(zip).size,files:files.length+1}));
