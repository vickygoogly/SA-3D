...
for(let x=-84;x<=84;x+=14)for(const z of [-58,56]){pipe([x,0,z],[x,6,z],.07,'dark');box(x,6,z,1.1,.2,.5,lampMaterial);}
// Dedicated transverse service lanes connect the two existing longitudinal roads.
for(const z of [-58,57]){box(.5,.08,z,65,.14,5,'dark');for(let x=-28;x<31;x+=8)box(x,.18,z,3,.04,.15,'yellow');}
