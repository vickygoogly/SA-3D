...
- Preserve the lagoon boundary, beach edge and curved staircase geometry in every performance mode. Optimize textures, planting density/LODs, hidden geometry, batching and shadow/pixel budgets first.
...
- Visual direction combines the first exterior and third cutaway concepts, plus the approved close-up curved ground stair concept.
